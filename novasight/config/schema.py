    ...
    schema = {
        ...
        "sections": [
            ...
            },
            {
                ...
                "label": "控制",
                "fields": [
                    {"path": "control.mode", "label": "控制模式", "type": "select", "options": ["universal_saturated", "calibrated_angular"], "restart_required": False},
                    ...
                    {"path": "control.shared.deadzone_x_px", "label": "共享：X 像素死区", "type": "float", "min": 0, "max": 10, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.shared.deadzone_y_px", "label": "共享：Y 像素死区", "type": "float", "min": 0, "max": 10, "step": 0.1, "precision": 1, "restart_required": False},
