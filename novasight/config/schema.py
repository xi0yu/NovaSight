    ...
    schema = {
        ...
        "sections": [
            ...
            },
            {
                ...
                "label": "控制",
                "fields": [
                    {"path": "control.active_algorithm", "label": "控制算法", "type": "select", "options": ["universal_saturated", "calibrated_angular", "ttbox_pid_atan", "dual_phase_atan_predictive_v1", "dual_phase_atan_robust_predictive_v2"], "restart_required": False},
                    ...
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.freshness_threshold_ms", "label": "精确 v2：控制新鲜度 ms", "type": "float", "min": 1, "max": 200, "step": 1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.aim.y_ratio", "label": "精确 v2：瞄点纵向比例", "type": "float", "min": 0, "max": 1, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.projection.fov_x_deg", "label": "精确 v2：水平 FOVX", "type": "float", "min": 30, "max": 179, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.projection.counts_per_360", "label": "精确 v2：每圈 counts", "type": "float", "min": 1, "step": 1, "precision": 0, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.projection.invert_y", "label": "精确 v2：反转 Y", "type": "bool", "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.mode.near_enter_min_px", "label": "精确 v2：进入 NEAR 最小 px", "type": "float", "min": 0, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.mode.near_exit_min_px", "label": "精确 v2：退出 NEAR 最小 px", "type": "float", "min": 0, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.mode.near_enter_bbox_h_ratio", "label": "精确 v2：进入 NEAR 框高比", "type": "float", "min": 0, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.mode.near_exit_bbox_h_ratio", "label": "精确 v2：退出 NEAR 框高比", "type": "float", "min": 0, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.velocity.smoothing_tau_ms", "label": "精确 v2：速度 EMA 时间常数 ms", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.velocity.history_reset_gap_ms", "label": "精确 v2：历史中断重置 ms", "type": "float", "min": 0.1, "max": 500, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.velocity.spread_base_px_ms", "label": "精确 v2：速度离散基础容许 px/ms", "type": "float", "min": 0.001, "step": 0.001, "precision": 3, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.velocity.spread_relative", "label": "精确 v2：速度离散相对容许", "type": "float", "min": 0, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.velocity.change_base_px_ms", "label": "精确 v2：趋势变化基础容许 px/ms", "type": "float", "min": 0.001, "step": 0.001, "precision": 3, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.velocity.change_relative", "label": "精确 v2：趋势变化相对容许", "type": "float", "min": 0, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.enabled_x", "label": "精确 v2：启用 X 预测", "type": "bool", "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.enabled_y", "label": "精确 v2：启用 Y 预测（固定关闭）", "type": "bool", "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.coefficient", "label": "精确 v2：预测强度", "type": "float", "min": 0, "max": 2, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.actuation_delay_ms", "label": "精确 v2：执行延迟 ms", "type": "float", "min": 0, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.max_horizon_ms", "label": "精确 v2：最大预测时域 ms", "type": "float", "min": 0, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.far.absolute_cap_px", "label": "精确 v2：FAR 预测绝对上限", "type": "float", "min": 0, "max": 100, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.far.base_cap_px", "label": "精确 v2：FAR 预测基础上限", "type": "float", "min": 0, "max": 100, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.far.relative_cap", "label": "精确 v2：FAR 预测相对上限", "type": "float", "min": 0, "max": 2, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.near.absolute_cap_px", "label": "精确 v2：NEAR 预测绝对上限", "type": "float", "min": 0, "max": 100, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.near.base_cap_px", "label": "精确 v2：NEAR 预测基础上限", "type": "float", "min": 0, "max": 100, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.prediction.near.relative_cap", "label": "精确 v2：NEAR 预测相对上限", "type": "float", "min": 0, "max": 2, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.atan.far.kp", "label": "精确 v2：FAR Kp", "type": "float", "min": 0.001, "max": 0.999, "step": 0.001, "precision": 3, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.atan.near.kp", "label": "精确 v2：NEAR Kp", "type": "float", "min": 0.001, "max": 0.999, "step": 0.001, "precision": 3, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.atan.far.scale_counts", "label": "精确 v2：FAR Atan 尺度", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.atan.near.scale_counts", "label": "精确 v2：NEAR Atan 尺度", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.atan.far.max_counts_per_update", "label": "精确 v2：FAR 单次上限", "type": "float", "min": 0.1, "max": 127, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.algorithms.dual_phase_atan_robust_predictive_v2.atan.near.max_counts_per_update", "label": "精确 v2：NEAR 单次上限", "type": "float", "min": 0.1, "max": 127, "step": 0.1, "precision": 1, "restart_required": False},
