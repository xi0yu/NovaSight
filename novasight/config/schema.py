        ...
        "sections": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {
                        "path": "control.shared.recoil_enabled",
                        "label": "共享：启用 Y 轴压枪",
                        "type": "bool",
                        "restart_required": False,
                    },
                    {
                        "path": "control.shared.recoil_start_delay_ms",
                        "label": "共享：压枪启动延迟 ms",
                        "type": "float",
                        "min": 0,
                        "max": 1000,
                    ...
                    {
                        "path": "control.shared.recoil_y_rate_counts_s",
                        "label": "共享：Y 压枪速率 counts/s",
                        "type": "float",
                        "min": 0,
                        "max": 5000,
                        "step": 1,
                    ...
                    {
                        "path": "control.shared.recoil_ramp_up_ms",
                        "label": "共享：压枪渐入 ms",
                        "type": "float",
                        "min": 0,
                        "max": 2000,
                    ...
                    {
                        "path": "control.shared.recoil_max_counts_per_observation",
                        "label": "共享：单观测最大压枪 counts",
                        "type": "float",
                        "min": 0.1,
                        "max": 20,
                        "step": 0.1,
