        ...
        "sections": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {"path": "control.dynamic_pid_target_error_threshold", "label": "动态PID 达标误差阈值", "type": "float", "min": 0, "restart_required": False},
                    ...
                    {"path": "control.dynamic_pid_error_mode", "label": "动态PID 误差模式", "type": "select", "options": ["roi_px", "model_px", "normalized", "fov_counts"], "restart_required": False},
                    {"path": "control.dynamic_pid_target_extent_mode", "label": "动态PID 目标尺度", "type": "select", "options": ["width", "height", "max_wh", "mean_wh"], "restart_required": False},
                    {"path": "control.dynamic_pid_y_sign", "label": "动态PID Y 方向", "type": "select", "options": ["up_positive", "down_positive"], "restart_required": False},
                    {"path": "control.dynamic_pid_fov_deg", "label": "动态PID FOV", "type": "float", "min": 1, "max": 179, "restart_required": False},
                    {"path": "control.dynamic_pid_counts_per_revolution_x", "label": "动态PID X c360", "type": "float", "min": 1, "restart_required": False},
                    {"path": "control.dynamic_pid_counts_per_revolution_y", "label": "动态PID Y c360", "type": "float", "min": 1, "restart_required": False},
                    {"path": "control.dynamic_pid_max_x", "label": "动态PID X 输出保护", "type": "float", "min": 0, "restart_required": False},
                    {"path": "control.dynamic_pid_max_y", "label": "动态PID Y 输出保护", "type": "float", "min": 0, "restart_required": False},
