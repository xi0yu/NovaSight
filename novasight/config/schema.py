    ...
    schema = {
        ...
        "sections": [
            ...
            },
            {
                ...
                "label": "控制",
                "fields": [
                    {"path": "control.mode", "label": "控制模式", "type": "select", "options": ["universal_saturated", "calibrated_angular", "ttbox_pid_atan"], "restart_required": False},
                    ...
                    {"path": "control.calibrated_angular.fov_x_deg", "label": "精确标定：水平 FOVX", "type": "float", "min": 30, "max": 179, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.calibrated_angular.counts_per_360_x", "label": "精确标定：X 每圈 counts", "type": "float", "min": 1, "step": 1, "precision": 0, "restart_required": False},
                    {"path": "control.calibrated_angular.counts_per_360_y", "label": "精确标定：Y 每圈 counts", "type": "float", "min": 1, "step": 1, "precision": 0, "restart_required": False},
                    {"path": "control.calibrated_angular.kp_x", "label": "精确标定：Kp X", "type": "float", "min": 0, "max": 2, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.calibrated_angular.kp_y", "label": "精确标定：Kp Y", "type": "float", "min": 0, "max": 2, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.calibrated_angular.kd_x", "label": "精确标定：Kd X", "type": "float", "min": 0, "max": 1, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.calibrated_angular.kd_y", "label": "精确标定：Kd Y", "type": "float", "min": 0, "max": 1, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.calibrated_angular.d_ema_alpha", "label": "精确标定：D 项 EMA", "type": "float", "min": 0.01, "max": 1, "step": 0.01, "precision": 2, "restart_required": False},
                    {"path": "control.calibrated_angular.max_angle_step_x_deg", "label": "精确标定：X 最大角度步长", "type": "float", "min": 0.0001, "step": 0.0001, "precision": 4, "restart_required": False},
                    {"path": "control.calibrated_angular.max_angle_step_y_deg", "label": "精确标定：Y 最大角度步长", "type": "float", "min": 0.0001, "step": 0.0001, "precision": 4, "restart_required": False},
                    {"path": "control.universal_saturated.response_scale_x_px", "label": "通用适配：水平响应尺度", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.universal_saturated.response_scale_y_px", "label": "通用适配：垂直响应尺度", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.universal_saturated.max_step_x_counts", "label": "通用适配：最大水平移动", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.universal_saturated.max_step_y_counts", "label": "通用适配：最大垂直移动", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.ttbox_pid_atan.response_scale_x_px", "label": "ttbox_pid_atan：水平响应尺度 px", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.ttbox_pid_atan.response_scale_y_px", "label": "ttbox_pid_atan：垂直响应尺度 px", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.ttbox_pid_atan.per_frame_gain_x", "label": "ttbox_pid_atan：X 每帧增益", "type": "float", "min": 0.001, "step": 0.001, "precision": 3, "restart_required": False},
                    {"path": "control.ttbox_pid_atan.per_frame_gain_y", "label": "ttbox_pid_atan：Y 每帧增益", "type": "float", "min": 0.001, "step": 0.001, "precision": 3, "restart_required": False},
                    {"path": "control.ttbox_pid_atan.max_step_x_counts", "label": "ttbox_pid_atan：X 最大 counts", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.ttbox_pid_atan.max_step_y_counts", "label": "ttbox_pid_atan：Y 最大 counts", "type": "float", "min": 0.1, "step": 0.1, "precision": 1, "restart_required": False},
                    {"path": "control.ttbox_pid_atan.normalize_to_dt", "label": "ttbox_pid_atan：按 dt 归一", "type": "bool", "restart_required": False},
                    {"path": "control.ttbox_pid_atan.nominal_dt_s", "label": "ttbox_pid_atan：标称帧间隔 s", "type": "float", "min": 0.001, "max": 0.2, "step": 0.001, "precision": 3, "restart_required": False},
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {"path": "hardware.min_effective_move_counts_x", "label": "kmNet X 最小有效 counts", "type": "int", "min": 1, "max": 64, "step": 1, "restart_required": False},
                    {"path": "hardware.min_effective_move_counts_y", "label": "kmNet Y 最小有效 counts", "type": "int", "min": 1, "max": 64, "step": 1, "restart_required": False},
                ],
            },
            {
                "id": "logging",
