        ...
        "sections": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {"path": "control.pid_ki_x", "label": "PID Ki X轴", "type": "float", "min": 0, "restart_required": False},
                    {"path": "control.pid_ki_y", "label": "PID Ki Y轴", "type": "float", "min": 0, "restart_required": False},
                    {"path": "control.pid_kd_x", "label": "PID Kd X轴", "type": "float", "min": 0, "restart_required": False},
                    {"path": "control.pid_kd_y", "label": "PID Kd Y轴", "type": "float", "min": 0, "restart_required": False},
                    {"path": "control.pid_integral_limit_x", "label": "PID 积分上限 X轴", "type": "float", "min": 0, "restart_required": False},
                    {"path": "control.pid_integral_limit_y", "label": "PID 积分上限 Y轴", "type": "float", "min": 0, "restart_required": False},
                    {"path": "control.pid_output_limit_x", "label": "PID 输出上限 X轴", "type": "float", "min": 0, "restart_required": False},
                    {"path": "control.pid_output_limit_y", "label": "PID 输出上限 Y轴", "type": "float", "min": 0, "restart_required": False},
