        ...
        "sections": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {"path": "control.strategy", "label": "鼠标算法", "type": "select", "options": ["pid", "isolated_mouse", "dynamic_pid", "experimental_angle_pid"], "restart_required": False},
                    ...
                    {"path": "control.experimental_angle_fov_x_deg", "label": "实验角度PID 水平FOV", "type": "float", "min": 1, "max": 179, "restart_required": False},
