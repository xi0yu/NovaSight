            ...
            },
            {
                ...
                "fields": [
                    {"path": "inference.enabled", "label": "启用推理", "type": "bool", "restart_required": False},
                    {
                        ...
                        "label": "推理后端",
                        "type": "select",
                        "options": ["nvmm_latest", "tensorrt", "onnxruntime", "deepstream"],
                        "restart_required": True,
                    },
                    {
                        "path": "inference.deepstream_manifest_path",
                        "label": "DeepStream Manifest",
                        "type": "string",
                        "restart_required": True,
                    },
                    {
                        "path": "inference.deepstream_config_path",
                        "label": "DeepStream nvinfer配置",
                        "type": "string",
                        "restart_required": True,
                    },
                    {
                        "path": "inference.deepstream_io_mode",
                        "label": "DeepStream V4L2 IO模式",
                        "type": "int",
                        "min": 0,
                        "max": 5,
                        "restart_required": True,
