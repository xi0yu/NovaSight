...
CONTROL_PARAM_SPECS: dict[str, ParamSpec] = {
    ...
    "control.shared.max_count_slew_x": _spec("control.shared.max_count_slew_x", "共享 X counts 增长限制", 10.0, 0.1, 1000.0, 0.1, "counts", "相邻观测 X 输出允许增加的最大 counts；减速立即生效，反向前先归零。"),
    "control.shared.max_count_slew_y": _spec("control.shared.max_count_slew_y", "共享 Y counts 增长限制", 8.0, 0.1, 1000.0, 0.1, "counts", "相邻观测 Y 输出允许增加的最大 counts；减速立即生效，反向前先归零。"),
