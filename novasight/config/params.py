...
CONTROL_PARAM_SPECS: dict[str, ParamSpec] = {
    ...
    "control.shared.recoil_y_rate_counts_s": _spec(
        "control.shared.recoil_y_rate_counts_s",
        "Y 压枪速率",
        0.0,
        0.0,
        5000.0,
    ...
    "control.shared.recoil_ramp_up_ms": _spec(
        "control.shared.recoil_ramp_up_ms",
        "压枪渐入",
        120.0,
        0.0,
        2000.0,
    ...
    "control.shared.recoil_max_counts_per_observation": _spec(
        "control.shared.recoil_max_counts_per_observation",
        "单观测最大压枪",
        8.0,
        0.1,
        20.0,
