...
def build_control_frame_record(
    *,
    ...
    return {
        ...
        "counts_x_float": _number(pipeline.get("counts_x_float")),
        "counts_y_float": _number(pipeline.get("counts_y_float")),
        "requested_counts_x": _number(pipeline.get("requested_counts_x")),
        "requested_counts_y": _number(pipeline.get("requested_counts_y")),
