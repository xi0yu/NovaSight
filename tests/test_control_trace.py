    ...
    return build_control_trace_record(
        control={
            ...
            "pipeline": {
                ...
                "final_dy": -2,
                "angular_controller": {
                    "derivative_x_rad_s": 0.18,
                    "derivative_y_rad_s": -0.07,
                    "derivative_x_raw_rad_s": 0.20,
                    "derivative_y_raw_rad_s": -0.08,
                    "zone": "middle",
                },
                "compensated_target": {
                    "delta_x": 3.0,
                    "delta_y": -1.0,
                    "compensation_ms": 24.0,
                    "prediction_confidence": 0.75,
                },
                "estimated_target_state": {
                    "track_id": 7,
                    "state_ts_ns": 1_020_000_000,
                    "x": 320.0,
                    "y": 240.0,
                    "vx": 150.0,
                    "vy": -25.0,
                    "position_sigma_px": 4.0,
                    "cov_trace": 20.0,
                    "nis": 1.2,
                    "prediction_confidence": 0.75,
                },
