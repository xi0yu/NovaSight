...
def test_runtime_schema_exposes_separate_algorithm_sections_and_product_labels() -> None:
    ...
    assert "control.recoil.enabled" in shared_paths
    assert "control.recoil.base_rate_counts_s" in shared_paths
    assert "control.recoil.max_rate_counts_s" in shared_paths
