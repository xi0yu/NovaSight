# Historical: NovaSight Capture + TensorRT Latest Baseline

> Archived 2026-09-20. This is not the production baseline. All former
> "current", "default" and "must" statements below are historical only.
> Use the [current GPU image contract](../../gpu-image-pipeline.md).
