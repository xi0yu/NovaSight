# Historical: NovaSight DeepStream Object-Meta GPU Image Mainline

> Archived 2026-09-20. Everything below describes a superseded CPU parser/NMS
> path, including its former "current" claims. Do not use it to configure or
> validate production. See the [current GPU image contract](../../gpu-image-pipeline.md).
