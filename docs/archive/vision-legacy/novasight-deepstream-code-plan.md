# Historical: NovaSight DeepStream/NVMM Code Plan

> Archived 2026-09-20. Former defaults, commands and requirements below are
> historical only, including the old supersession notice. Use the
> [current GPU image contract](../../gpu-image-pipeline.md).
