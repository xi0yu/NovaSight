...
| Tracking | `detection-box`, `target-center`, `candidate-target`, `current-target`, `target-lock`, `target-lost`, `target-filter`, `fov`, `track-trace`, `kalman`, `velocity-vector`, `acceleration`, `future-position`, `confidence`, `track-id`, `occlusion`, `reidentify`, `target-switch`, `prediction-line`, `target-quality` |
