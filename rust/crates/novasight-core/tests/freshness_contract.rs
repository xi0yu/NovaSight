...
//! against the Python `FreshnessGate` reference implementation: the
//! exporter writes expected admit/reject outcomes into
//! `freshness-reset.jsonl`; this test parses the same records and
